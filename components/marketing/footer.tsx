        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://www.instagram.com/emiday.ai" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-[#71717a] hover:text-white hover:border-white/[0.12] transition-all" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/emiday-ai/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-[#71717a] hover:text-white hover:border-white/[0.12] transition-all" aria-label="LinkedIn">
